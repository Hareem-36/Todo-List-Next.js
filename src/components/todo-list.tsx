...
export default function TodoList() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-lime-400 to-orange-400">
      {/* Center the todo list within the screen */}
      <div className="w-full max-w-md bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
        {/* Header with title */}
      <u><b><center><h1 className="text-4xl font-bold mb-4 text-blue-800 dark:text-blue800">
          Todo List
        </h1></center></b></u>
        ...
        <div className="flex items-center mb-4">
          <Input
            ...
            className="flex-1 mr-2 px-3 py-2 rounded-md border border-blue-900 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200"
          />
          <Button
            onClick={addTask}
            className="bg-blue-800 hover:bg-pink-400 text-white font-medium py-2 px-4 rounded-md"
          >
            Add
          </Button>
        </div>
              ...
              <div className="flex items-center">
                {editingTaskId === task.id ? (
                  ...
                  <Button
                    ...
                    className="bg-gray-300 font-bold hover:bg-gray-400 text-gray-800 dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-gray-200 font-medium py-1 px-2 rounded-md mr-2"
                  >
                    Edit
                  </Button>
                )}
